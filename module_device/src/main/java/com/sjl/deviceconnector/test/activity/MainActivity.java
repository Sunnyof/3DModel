...
//            }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_open_serial_port_list) {
            Intent serverIntent = new Intent(this, SerialPortListActivity.class);
            startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE);
        } else if (id == R.id.btn_open_serial_port_config || id == R.id.btn_open_usb_serial_port_config) {
            openActivity(SerialPortSettingActivity.class);
        } else if (id == R.id.btn_open_usb_list || id == R.id.btn_open_usb_serial_port_list) {
            Intent serverIntent = new Intent(this, UsbListActivity.class);
            startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE);
        } else if (id == R.id.btn_open_bluetooth_list) {
...
//            }
            startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE);
        } else if (id == R.id.btn_open_wifi_setting) {
            ...
            send();
        } else if (id == R.id.btn_test_server) {//需要申请一个前台通知，防止高版本服务挂掉
