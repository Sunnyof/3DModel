...
open class SplashView : BaseActivity() {
...
// endregion
    ...
    fun showLog(str: String) {
        Toast.makeText(this@SplashView, str, Toast.LENGTH_LONG).show()
    }
    ...
    fun axis1X(x:Int){
        if(x>65535||x<-65535){
            Toast.makeText(this@SplashView, "数组越界了", Toast.LENGTH_LONG).show()
            return
        }
